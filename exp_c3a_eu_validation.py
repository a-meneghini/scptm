...
C3A re-run using EU_Debates from results_v3 — consistent with paper corpus.
...
WORDS_DIR  = BASE.parent / "results_v3"          # EU_Debates words live here
MAIN_TABLE = WORDS_DIR / "main_table.csv"
OUT_CSV    = WORDS_DIR / "c3a_vader_validation.csv"

CORPORA = ["HateSpeech", "Reddit_Pol", "EU_Debates", "20NG"]
MODEL   = "SCPTM"
...
def load_phrases(corpus, model, best_k):
